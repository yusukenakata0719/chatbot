...
urlpatterns = [
    ...
    path('save_json_to_model/', views.save_json_to_model, name='save_json_to_model'),
    path('upload_web/', views.upload_web, name='upload_web'),
    path('dealing_web/', views.dealing_web, name='dealing_web'),
    path('save_json_from_model/', views.save_json_from_model, name='save_json_from_model'),
